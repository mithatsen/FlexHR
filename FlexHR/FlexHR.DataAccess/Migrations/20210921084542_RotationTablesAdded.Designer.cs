...
namespace FlexHR.DataAccess.Migrations
{
    ...
    [Migration("20210921084542_RotationTablesAdded")]
    partial class RotationTablesAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.ColorCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.JobRotation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("JobRotation");
                });

            modelBuilder.Entity("FlexHR.Entity.Concrete.JobRotationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("JobRotationDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("JobRotationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("JobRotationId");

                    b.ToTable("JobRotationHistory");
                });
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.StaffLeave", b =>
                {
                    ...
                    b.Property<int?>("WhoApprovedStaffId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.StaffPersonelInfo", b =>
                {
                    ...
                    b.Property<string>("PartnerWorkingStatus")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.StaffSalary", b =>
                {
                    ...
                    b.Property<decimal?>("OvertimePayPerHour")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.TakePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.JobRotationHistory", b =>
                {
                    b.HasOne("FlexHR.Entity.Concrete.JobRotation", "JobRotations")
                        .WithMany("JobRotationHistories")
                        .HasForeignKey("JobRotationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("JobRotations");
                });
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.Staff", b =>
                {
                    b.HasOne("FlexHR.Entity.Concrete.JobRotation", "JobRotation")
                        .WithMany("Staffs")
                        .HasForeignKey("JobRotationId");

                    b.Navigation("JobRotation");
                });
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.JobRotation", b =>
                {
                    b.Navigation("JobRotationHistories");
