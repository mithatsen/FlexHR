...
namespace FlexHR.DataAccess.Migrations
{
    ...
    [Migration("20210621092259_deleteRequiredAttrUSerNAmeAndPasswordFromStaff")]
    partial class deleteRequiredAttrUSerNAmeAndPasswordFromStaff
    {
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.PublicHoliday", b =>
                {
                    ...
                    b.Property<decimal>("HolidayDuration")
            ...
            modelBuilder.Entity("FlexHR.Entity.Concrete.StaffLeave", b =>
                {
                    ...
                    b.Property<int>("LeaveTypeGeneralSubTypeId")
                        .HasColumnType("int");
